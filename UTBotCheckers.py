...
regular_roles = [469158572417089546, 490250496028704768, 667104998714245122]

async def in_secret_channel(ctx: commands.Context):
...
async def in_botspam(ctx: commands.Context):
...
async def is_regular(ctx: commands.Context):
...
async def is_nitro(ctx: commands.Context):
...
async def is_brandon(ctx: commands.Context):
